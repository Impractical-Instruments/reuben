...
#[library_benchmark]
#[bench::add(args = ("add_f32_signal",), setup = OpHarness::for_kind)]
#[bench::add_value(args = ("add_f32_value",), setup = OpHarness::for_kind)]
...
#[bench::differentiate(args = ("differentiate_f32_signal",), setup = OpHarness::for_kind)]
...
#[bench::integrate(args = ("integrate_f32_signal",), setup = OpHarness::for_kind)]
#[bench::lfo(args = ("lfo",), setup = OpHarness::for_kind)]
#[bench::m2s(args = ("m2s",), setup = OpHarness::for_kind)]
#[bench::map(args = ("map_f32_signal",), setup = OpHarness::for_kind)]
#[bench::map_value(args = ("map_f32_value",), setup = OpHarness::for_kind)]
#[bench::mul(args = ("mul_f32_signal",), setup = OpHarness::for_kind)]
#[bench::mul_value(args = ("mul_f32_value",), setup = OpHarness::for_kind)]
...
#[bench::power(args = ("power_f32_signal",), setup = OpHarness::for_kind)]
#[bench::power_value(args = ("power_f32_value",), setup = OpHarness::for_kind)]
