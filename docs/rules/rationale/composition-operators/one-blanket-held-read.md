...
The pull toward generating it anyway is real, because the derive is already walking the type and
emitting code, and one more impl per enum looks free. It is not free in the way that matters: each
